 ...
 * @author Georgios
 */
public class BestPipelineForD7 extends AbstractBestConfiguration {

    public BestPipelineForD7(AbstractDuplicatePropagation dp, List<EntityProfile> pf1, List<EntityProfile> pf2) {
        super(dp, pf1, pf2);
    }
    ...
    public void applyWorkflow() {
        ...
        bf.setNumberedGridConfiguration(15);
        ...
        final ProfileMatcher pm = new ProfileMatcher(profiles1, profiles2,
                RepresentationModel.CHARACTER_FOURGRAMS, SimilarityMetric.ENHANCED_JACCARD_SIMILARITY);
    ...
    public static void main(String[] args) {
        ...
        for (int datasetId = 0; datasetId < datasetsD1.length; datasetId++) {
            ...
            final BestPipelineForD7 bf1d7 = new BestPipelineForD7(duplicatePropagation, profiles1, profiles2);
            bf1d7.applyWorkflow();
            bf1d7.printPerformance();
        }
    }
}

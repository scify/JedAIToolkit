 ...
 * @author Georgios
 */
public class BestPipelineForD3 extends AbstractBestConfiguration {

    public BestPipelineForD3(AbstractDuplicatePropagation dp, List<EntityProfile> pf1, List<EntityProfile> pf2) {
        super(dp, pf1, pf2);
    }
    ...
    public void applyWorkflow() {
        ...
        bf.setNumberedGridConfiguration(23);
        ...
        final ProfileMatcher pm = new ProfileMatcher(profiles1, profiles2,
                RepresentationModel.TOKEN_BIGRAMS_TF_IDF, SimilarityMetric.COSINE_SIMILARITY);
        simPairs = pm.executeComparisons(blocks);

        umc = new UniqueMappingClustering();
        umc.setNumberedGridConfiguration(0);
    ...
    public static void main(String[] args) {
        ...
        for (int datasetId = 0; datasetId < datasetsD1.length; datasetId++) {
            ...
            final BestPipelineForD3 bf1d3 = new BestPipelineForD3(duplicatePropagation, profiles1, profiles2);
            bf1d3.applyWorkflow();
            bf1d3.printPerformance();
        }
    }
}

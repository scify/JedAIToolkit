 ...
 * @author Georgios
 */
public class BestPipelineForD1 extends AbstractBestConfiguration {

    public BestPipelineForD1(AbstractDuplicatePropagation dp, List<EntityProfile> pf1, List<EntityProfile> pf2) {
        super(dp, pf1, pf2);
    }
    ...
    public void applyWorkflow() {
        ...
        bf.setNumberedGridConfiguration(1);
        ...
        final ProfileMatcher pm = new ProfileMatcher(profiles1, profiles2,
                RepresentationModel.CHARACTER_BIGRAMS, SimilarityMetric.COSINE_SIMILARITY);
    ...
    public static void main(String[] args) {
        ...
        for (int datasetId = 0; datasetId < datasetsD1.length; datasetId++) {
            ...
            final BestPipelineForD1 bf1d1 = new BestPipelineForD1(duplicatePropagation, profiles1, profiles2);
            bf1d1.applyWorkflow();
            bf1d1.printPerformance();
        }
    }
}

 ...
 * @author Georgios
 */
public class BestPipelineForD6 extends AbstractBestConfiguration {

    public BestPipelineForD6(AbstractDuplicatePropagation dp, List<EntityProfile> pf1, List<EntityProfile> pf2) {
        super(dp, pf1, pf2);
    }
    ...
    public void applyWorkflow() {
        ...
        bf.setNumberedGridConfiguration(37);
        ...
        final ProfileMatcher pm = new ProfileMatcher(profiles1, profiles2,
                RepresentationModel.TOKEN_BIGRAMS_TF_IDF, SimilarityMetric.ARCS_SIMILARITY);
    ...
    public static void main(String[] args) {
        ...
        for (int datasetId = 0; datasetId < datasetsD1.length; datasetId++) {
            ...
            final BestPipelineForD6 bf1d6 = new BestPipelineForD6(duplicatePropagation, profiles1, profiles2);
            bf1d6.applyWorkflow();
            bf1d6.printPerformance();
        }
    }
}
